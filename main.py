...
for iter in df_FileInputs.itertuples():  # ITERATE THROUGH DATA FILES
    ...
    if TestForAMOUNT == True:
        ...
        for loop2 in range(
                len(df_Statement)):  # df_temp loops columns, df_temp.index loops rows, no () or [] needed here
            ...
            print("AMOUNT, CREDIT, DEBIT =", df_Statement.at[loop2, "AMOUNT"], df_Statement.at[loop2, "CREDIT"],
                  df_Statement.at[loop2, "DEBIT"])
